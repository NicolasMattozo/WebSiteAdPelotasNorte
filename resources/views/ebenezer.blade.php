...
<body style="background-color: #F5F5DC">
    ...
    <div style="background-color: #000000">
            ...
            <div class="container ">
                <div class="row">
                    <div class="col-12">
                        ...
                        <img src="graphics/ebenezerSVG.svg" class="img-fluid w-50 d-block d-sm-none mx-auto h-75" alt="Imagem 1">
                        <!-- Imagem para telas grandes -->
                        <img src="graphics/ebenezerSVG.svg" class="img-fluid w-100 d-none d-sm-block mx-auto h-75" alt="Imagem 2">
                    </div>
                </div>
            </div>
            <h1 style="color: #daa520">QUEM SOMOS</h1>
            <br>
            <br>
            <p style="color: #ffffff">Seja bem-vindo à Assembleia de Deus Pelotas Norte, uma igreja comprometida com a pregação do Evangelho de
        ...
        <div class="container pt-5 pb-5">
            <h1 style="color: #daa520"class="text-center">SUPERINTENDÊNCIA</h1>
            <div class="container mt-4">
                <div class="row">
                    <div class="col-md-6 position-relative text-center">
                        <img src="imgs/icone1.jpg" class="img-fluid rounded-3 w-100">
                        <div class="position-absolute bottom-0 start-1 text-#daa520 p-2 rounded">
            ...
            <div class="container pt-5 pb-5">
                <h1 style="color: #daa520"class="text-center">Sigam nossas redes-sociais</h1>
                <div class="d-flex gap-3 mb-2 mb-lg-0 ms-lg-auto justify-content-center">
                    <a href="https://www.instagram.com/adnorteonline" target="_blank" class="d-inline-block">
                        <i class="fab fa-instagram" style="font-size: 30px; color: rgb(255, 255, 255);"></i>
                    </a>
                    <a href="https://www.facebook.com/profile.php?id=61552326531887" target="_blank"
                        class="d-inline-block">
                        <i class="fab fa-facebook" style="font-size: 30px; color: rgb(255, 255, 255);"></i>
                    </a>
