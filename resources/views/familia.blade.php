...
<body style="background-color: #F5F5DC">
    ...
    <div style="background-color: #6d3a1d">
            ...
            <div class="container ">
                <div class="row">
                    <div class="col-12">
                        ...
                        <img src="graphics/UMADPEL.svg" class="img-fluid w-50 d-block d-sm-none mx-auto h-75" alt="Imagem 1">
                        <!-- Imagem para telas grandes -->
                        <img src="graphics/UMADPEL.svg" class="img-fluid w-50 d-none d-sm-block mx-auto" alt="Imagem 2">
                    </div>
                </div>
            </div>
